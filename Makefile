...
# NDB sources
override SOURCES  += src/ndb/nickeldbus.cc src/ndb/NDBDbus.cc src/ndb/NDBCfmDlg.cc src/ndb/NDBWidgets.cc src/ndb/NDBMetadata.cc src/ndb/util.cc $(IFACE_DIR)/ndb_adapter.cpp  
# NM sources
...
override MOCS 	  += src/ndb/NDBDbus.h src/ndb/NDBCfmDlg.h src/ndb/NDBWidgets.h src/ndb/NDBMetadata.h $(IFACE_DIR)/ndb_adapter.h
